...
def showStatus(): # display the player's status
 ...
 #       print(rooms[currentRoom]['desc'])
    ...
    if 'item2' in rooms[currentRoom]:
        print('You see a ' + rooms[currentRoom]['item2'] + rooms[currentRoom]['item_status2'] + '.')
...
rooms = {
        'HALL' : {
            ...
            'item_status2': ' big ass useless knife, that makes you look intimidating', 
            'randenc' : '20',
...
while True:   # MAIN INFINITE LOOP
    ...
    if move[0] == 'get':
        if 'item' in rooms[currentRoom] and move[1]in rooms[currentRoom]['item']:
            ...
            inventory += [move[1]] # add item to inventory
            print(move[1].capitalize() + ' received!') # msg saying you received the item
            del rooms[currentRoom]['item2'] # deletes that item from the dictionary
